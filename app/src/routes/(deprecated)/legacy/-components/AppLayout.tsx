...
function BottomDock() {
  return (
    <div className="dock dock-sm bg-base-100/90 backdrop-blur supports-[backdrop-filter]:bg-base-100/75 lg:hidden">
      ...
      <a href="/legacy/browse" className="flex flex-col items-center">
        {/* Browse icon */}
        <svg
          className="size-[1.2em]"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="/legacy/collection" className="flex flex-col items-center">
        {/* Collection icon */}
        <svg
          className="size-[1.2em]"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="/legacy/account" className="flex flex-col items-center">
        {/* Account icon */}
        <svg
          className="size-[1.2em]"
          xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <aside className="hidden lg:flex w-64 flex-col bg-base-200 border-r border-base-300">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <a href="/legacy/browse" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-base-300 transition-colors">
          <svg className="size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <a href="/legacy/collection" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-base-300 transition-colors">
          <svg className="size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <a href="/legacy/account" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-base-300 transition-colors">
          <svg className="size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
