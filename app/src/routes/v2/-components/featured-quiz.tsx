...
function FeaturedQuiz() {
  return (
    <div className="card bg-base-300 rounded-4xl w-full flex flex-col gap-4 py-6">
      ...
      <h3 className="text-2xl font-bold ml-6 my-4">
        Imagine you are a space cat
      </h3>
      <div className="flex flex-row ml-6 mb-6 overflow-x-scroll scroll- gap-4 scroll-smooth snap-x [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <FeaturedQuizItem
...
function FeaturedQuizItem({ imageUrl, title }: FeaturedQuizItemProps) {
  return (
    <div className="snap-start rounded-xl w-40 h-56 overflow-hidden relative shrink-0">
