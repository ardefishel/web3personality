      ...
      GET: () => {
        return json({
          ...
          miniapp: {
            ...
            iconUrl: `${import.meta.env.VITE_PUBLIC_URL}/type3-logo.png`,
            splashImageUrl: `${import.meta.env.VITE_PUBLIC_URL}/type3-logo.png`,
            ...
            heroImageUrl: `${import.meta.env.VITE_PUBLIC_URL}/type3-logo.png`,
            tagline: "Personality on Chain",
            ogTitle: import.meta.env.VITE_APP_NAME,
            ogDescription: "Find your personality on chain",
            ogImageUrl: `${import.meta.env.VITE_PUBLIC_URL}/type3-logo.png`,
            noindex: true,
          },
        });
      },
